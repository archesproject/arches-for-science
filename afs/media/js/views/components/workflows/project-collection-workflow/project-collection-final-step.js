define([
    ...
    function viewModel(params) {
        ...
        this.relatedResources.subscribe(function(val){
            // 77d8cf19-ce9c-4e0a-bde1-9148d870e11c
            const physicalThingType = '8ddfe3ab-b31d-11e9-aff0-a4d18cec433a';
            ...
            self.collectionOfParentPhysThings(collectionOfPhysThings.filter(rr =>
                !rr.tiles.find(tile =>
                    tile.nodegroup_id === physicalThingType &&
                    tile.data[physicalThingType].find(value =>
