...
def update_workflow_plugins(apps, schema_editor):
    ...
    # update workflow plugin configs
    for plugin in plugins:
        ...
        elif str(plugin.pluginid) == "129d18d4-261a-4a3c-b46e-cf74e71d848c":
            plugin.config = {
                "show": False, 
                "is_workflow": True,
                "thumbnailBackgroundColor": "#3e89cd",
    ...
    # Adds 'Add Chemical Analysis Images" workflow
    if "af06e949-5e16-49f0-b23e-e8529e8ce321" not in [str(plugin.pluginid) for plugin in plugins]:
        add_chemical_analysis_images_workflow_plugin = Plugin.objects.create(
        ...
        add_chemical_analysis_images_workflow_plugin.save()

    # Re-adds review-dataset workflow with correct pluginid
    ...
    if len(review_dataset_workflow_plugin_query):
        ...
        review_dataset_workflow_plugin = Plugin.objects.create(
        ...
        review_dataset_workflow_plugin.save()
