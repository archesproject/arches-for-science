...
import collectionSetSceneTemplate from 'templates/views/components/reports/collection-set.htm';
import arches from 'arches';
import reportUtils from 'utils/report';
import 'views/components/reports/scenes/name';

export default ko.components.register('collection-set-report', {
