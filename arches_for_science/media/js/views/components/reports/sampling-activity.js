...
import samplingActivityReportTemplate from 'templates/views/components/reports/sampling-activity.htm';
import arches from 'arches';
import reportUtils from 'utils/report';
import 'views/components/reports/scenes/name';

export default ko.components.register('sampling-activity-report', {
    ...
    template: samplingActivityReportTemplate
});