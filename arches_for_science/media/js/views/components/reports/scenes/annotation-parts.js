...
import annotationPartsSceneTemplate from 'templates/views/components/reports/scenes/annotation-parts.htm'; 
...
export default ko.components.register('views/components/reports/scenes/annotation-parts', {
