...
import existenceSceneTemplate from 'templates/views/components/reports/scenes/existence.htm';
import reportUtils from 'utils/report';
import'bindings/datatable';

export default ko.components.register('views/components/reports/scenes/existence', {
