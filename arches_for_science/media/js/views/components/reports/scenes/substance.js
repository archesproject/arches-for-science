...
import substanceSceneTemplate from 'templates/views/components/reports/scenes/substance.htm';
import arches from 'arches';
import reportUtils from 'utils/report';
import 'bindings/datatable';

export default ko.components.register('views/components/reports/scenes/substance', {
    ...
    template: substanceSceneTemplate
});