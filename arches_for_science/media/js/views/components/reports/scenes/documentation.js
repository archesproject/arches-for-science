...
import documentationSceneTemplate from 'templates/views/components/reports/scenes/documentation.htm';
import arches from 'arches';
import reportUtils from 'utils/report';
import 'bindings/datatable';

export default ko.components.register('views/components/reports/scenes/documentation', {
