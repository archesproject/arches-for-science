...
import groupReportTemplate from 'templates/views/components/reports/group.htm';
import arches from 'arches';
import reportUtils from 'utils/report';
import 'views/components/reports/scenes/name';
import 'views/components/reports/scenes/communication';

export default ko.components.register('group-report', {
