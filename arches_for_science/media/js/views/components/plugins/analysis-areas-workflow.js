...
import analysisAreasWorkflowTemplate from 'templates/views/components/plugins/analysis-areas-workflow.htm';
import 'viewmodels/workflow-step';
import 'views/components/workflows/select-phys-thing-step';
import 'views/components/workflows/analysis-areas-workflow/analysis-areas-image-step';
import 'views/components/workflows/analysis-areas-workflow/analysis-areas-annotation-step';
import 'views/components/workflows/analysis-areas-workflow/analysis-areas-final-step';

export default ko.components.register('analysis-areas-workflow', {
