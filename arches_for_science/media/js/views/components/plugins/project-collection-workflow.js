...
import 'views/components/workflows/project-collection-workflow/project-collection-final-step';

export default ko.components.register('project-collection-workflow', {
