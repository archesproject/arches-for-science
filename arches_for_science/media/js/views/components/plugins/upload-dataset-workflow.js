...
import 'views/components/workflows/upload-dataset/dataset-step';
import 'views/components/workflows/upload-dataset/instrument-info-step';
import 'views/components/workflows/upload-dataset/upload-dataset-final-step';
import 'views/components/workflows/upload-dataset/file-interpretation-step';
import 'views/components/workflows/upload-dataset/select-renderer-step';
import 'views/components/workflows/upload-dataset/select-dataset-files-step';
import 'views/components/workflows/upload-dataset/upload-files-step';

export default ko.components.register('upload-dataset-workflow', {
