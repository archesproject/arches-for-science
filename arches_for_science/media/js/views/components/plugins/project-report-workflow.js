...
import 'views/components/workflows/project-report-workflow/download-report';
import 'views/components/workflows/project-report-workflow/download-project-files';
import 'views/components/workflows/project-report-workflow/add-annotations';

export default ko.components.register('project-report-workflow', { 
