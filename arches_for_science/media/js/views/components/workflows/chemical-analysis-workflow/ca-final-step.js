...
import chemicalAnalysisFinalStepTemplate from 'templates/views/components/workflows/chemical-analysis-workflow/ca-final-step.htm';
...
ko.components.register('ca-final-step', {
    viewModel: viewModel,
    template: chemicalAnalysisFinalStepTemplate
});
